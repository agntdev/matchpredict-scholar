...
const HELP =
  "Use the menu to view today’s research digest, look up a match, review anonymised history, or inspect a prediction.\n\n" +
  "Match IDs and search terms are the only details you need to type.";
